...
describe('Ticket Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      contributor: 'AAAAAAA',
      contributorVisibility: false,
      entityVisibility: false,
      directionVisibility: false,
      centralAnimator: 'AAAAAAA',
      centralRelay: 'AAAAAAA',
      regionalRelay: 'AAAAAAA',
      stateTicket: StateTicket.OPENED,
      statusTicket: Status.CREATED,
      pertinence: false,
    };
  });
  ...
  describe('Service methods', () => {
      ...
      const returnedFromService = Object.assign(
        {
          ...
          centralAnimator: 'BBBBBB',
          centralRelay: 'BBBBBB',
          regionalRelay: 'BBBBBB',
          stateTicket: 'BBBBBB',
          statusTicket: 'BBBBBB',
          pertinence: true,
        },
    ...
    describe('addTicketToCollectionIfMissing', () => {
      ...
      it('should add only unique Ticket to an array', () => {
        const ticketArray: ITicket[] = [{ id: 123 }, { id: 456 }, { id: 58321 }];
